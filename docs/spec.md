...
`fnc`, `xilit`, `yuxadalo`, `yazde`, `esha`, `nagah`, `sanna`, `khi`, `cqachunna`, `yallalc`, `chu`, `sac`, `khida`, `baram`, `parse_terah`, `parse_daqosh`, `to_terah`, `to_daqosh`, `push`, `pop`, `kep`, `baqderg`, `xarco`, `a`, `ya`, `terah`, `bool`, `deshnash`, `daqosh`.
